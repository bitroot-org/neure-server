...
--
-- Host: neure-db.cvcyqciaqbo3.ap-south-1.rds.amazonaws.com    Database: neure_prod
-- ------------------------------------------------------
...
CREATE TABLE `prodesk_clients` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_client_therapist` (`user_id`,`therapist_id`),
...
--
-- Table structure for table `prodesk_feedback`
--

DROP TABLE IF EXISTS `prodesk_feedback`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prodesk_feedback` (
  `id` int NOT NULL AUTO_INCREMENT,
  `therapist_id` int NOT NULL,
  `subject` varchar(255) NOT NULL,
  `message` text NOT NULL,
  `rating` int DEFAULT NULL COMMENT '1-5 stars, optional',
  `status` enum('new','reviewed','resolved') DEFAULT 'new',
  `admin_notes` text,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_pf_therapist` (`therapist_id`),
...
CREATE TABLE `prodesk_invoices` (
  ...
  `notes` text,
  `status` enum('draft','sent','payment_initiated','paid','overdue','cancelled','refunded') DEFAULT 'draft',
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `last_sent_at` timestamp NULL DEFAULT NULL COMMENT 'Last time invoice email/SMS was sent or resent',
  `razorpay_refund_id` varchar(100) DEFAULT NULL COMMENT 'Razorpay refund ID (rfnd_xxx)',
  `refunded_at` timestamp NULL DEFAULT NULL COMMENT 'When refund was confirmed by Razorpay',
  `invoice_pdf_url` varchar(500) DEFAULT NULL COMMENT 'S3 URL of generated invoice PDF',
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `prodesk_offer_emails`
--

DROP TABLE IF EXISTS `prodesk_offer_emails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prodesk_offer_emails` (
  `id` int NOT NULL AUTO_INCREMENT,
  `offer_id` int NOT NULL,
  `email` varchar(255) NOT NULL,
  `is_used` tinyint(1) DEFAULT '0',
  `used_at` timestamp NULL DEFAULT NULL,
  `used_by_therapist_id` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `prodesk_offer_tags`
--

DROP TABLE IF EXISTS `prodesk_offer_tags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prodesk_offer_tags` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `prodesk_offers`
--

DROP TABLE IF EXISTS `prodesk_offers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prodesk_offers` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  `percent_discount` decimal(5,2) DEFAULT NULL COMMENT 'e.g. 10.00 for 10% off',
  ...
  `total_max_uses` int DEFAULT NULL COMMENT 'NULL = unlimited (among whitelisted)',
...
CREATE TABLE `prodesk_payment` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `method` enum('razorpay','offline') DEFAULT 'razorpay' COMMENT 'How payment was made',
  `razorpay_refund_id` varchar(100) DEFAULT NULL COMMENT 'Razorpay refund ID (rfnd_xxx)',
  PRIMARY KEY (`id`),
...
CREATE TABLE `prodesk_payment_log` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `event_type` varchar(60) DEFAULT NULL COMMENT 'invoice.sent | payment.captured | payment.failed | refund.initiated | refund.processed | refund.failed | invoice.expired | invoice.cancelled | manual.marked_paid | overdue.flagged | invoice.resent',
  `source` enum('therapist','client','webhook','system') DEFAULT NULL COMMENT 'Who triggered this event',
  `invoice_id` int DEFAULT NULL COMMENT 'Denormalised for quick log fetch by invoice',
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `prodesk_pending_upgrades`
--

DROP TABLE IF EXISTS `prodesk_pending_upgrades`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prodesk_pending_upgrades` (
  `id` int NOT NULL AUTO_INCREMENT,
  `therapist_id` int NOT NULL,
  `old_subscription_id` int NOT NULL COMMENT 'FK → prodesk_subscriptions.id',
  `new_plan_id` int NOT NULL COMMENT 'FK → prodesk_plans.id',
  `new_billing_cycle` enum('monthly','annual') NOT NULL,
  `prorate_amount` decimal(10,2) NOT NULL,
  `razorpay_order_id` varchar(100) NOT NULL COMMENT 'Order for prorate charge',
  `razorpay_payment_id` varchar(100) DEFAULT NULL,
  `new_period_start` date NOT NULL COMMENT 'Today = prorate charge date',
  `new_period_end` date NOT NULL COMMENT 'old current_period_end = start of first full new cycle',
  `status` enum('pending','completed','expired') NOT NULL DEFAULT 'pending',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_ppu_order` (`razorpay_order_id`),
  KEY `idx_ppu_therapist` (`therapist_id`),
  KEY `fk_ppu_old_sub` (`old_subscription_id`),
  KEY `fk_ppu_plan` (`new_plan_id`),
  CONSTRAINT `fk_ppu_old_sub` FOREIGN KEY (`old_subscription_id`) REFERENCES `prodesk_subscriptions` (`id`),
  CONSTRAINT `fk_ppu_plan` FOREIGN KEY (`new_plan_id`) REFERENCES `prodesk_plans` (`id`),
  CONSTRAINT `fk_ppu_therapist` FOREIGN KEY (`therapist_id`) REFERENCES `therapists` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `prodesk_plans`
--

DROP TABLE IF EXISTS `prodesk_plans`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prodesk_plans` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  ...
  `per_unit_price` decimal(10,2) DEFAULT NULL COMMENT 'Clinic: price per psychologist/month',
  `client_limit` int DEFAULT NULL COMMENT '2 for starter, NULL = unlimited',
  `is_active` tinyint(1) DEFAULT '1',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Seeded pricing tiers — 8 rows total';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `prodesk_referral_payouts`
--

DROP TABLE IF EXISTS `prodesk_referral_payouts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prodesk_referral_payouts` (
  `id` int NOT NULL AUTO_INCREMENT,
  `therapist_id` int NOT NULL,
  `amount` decimal(10,2) NOT NULL,
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_prp_therapist` (`therapist_id`),
  CONSTRAINT `fk_prp_therapist` FOREIGN KEY (`therapist_id`) REFERENCES `therapists` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `prodesk_referral_wallet`
--

DROP TABLE IF EXISTS `prodesk_referral_wallet`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prodesk_referral_wallet` (
  `id` int NOT NULL AUTO_INCREMENT,
  `therapist_id` int NOT NULL,
...
--
-- Table structure for table `prodesk_referral_wallet_ledger`
--

DROP TABLE IF EXISTS `prodesk_referral_wallet_ledger`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prodesk_referral_wallet_ledger` (
  `id` int NOT NULL AUTO_INCREMENT,
  `therapist_id` int NOT NULL,
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_prwl_therapist` (`therapist_id`),
  CONSTRAINT `fk_prwl_therapist` FOREIGN KEY (`therapist_id`) REFERENCES `therapists` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `prodesk_referrals`
--

DROP TABLE IF EXISTS `prodesk_referrals`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prodesk_referrals` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  `first_subscription_id` int DEFAULT NULL,
  `reward_amount` decimal(10,2) DEFAULT NULL COMMENT '10% of first subscription payment',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `converted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_referred` (`referred_therapist_id`) COMMENT 'One referral record per referred therapist',
  KEY `fk_pr_referrer` (`referrer_therapist_id`),
...
--
-- Table structure for table `prodesk_subscription_payments`
--

DROP TABLE IF EXISTS `prodesk_subscription_payments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prodesk_subscription_payments` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  `razorpay_invoice_id` varchar(100) DEFAULT NULL COMMENT 'inv_xxx from Razorpay subscription charge',
  `cycle_number` int NOT NULL DEFAULT '1' COMMENT 'Which billing cycle (1=first)',
  `billing_period_start` date DEFAULT NULL COMMENT 'Period start this payment covers',
  `billing_period_end` date DEFAULT NULL COMMENT 'Period end this payment covers',
  `status` enum('created','captured','failed','refunded') DEFAULT 'created',
  `payment_for` enum('new','renewal','prorate_upgrade') NOT NULL DEFAULT 'new',
  `paid_at` timestamp NULL DEFAULT NULL,
  `meta` json DEFAULT NULL COMMENT 'Full Razorpay response payload',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_psp_subscription` (`subscription_id`),
  KEY `fk_psp_therapist` (`therapist_id`),
  KEY `idx_ssp_invoice` (`razorpay_invoice_id`),
...
--
-- Table structure for table `prodesk_subscriptions`
--

DROP TABLE IF EXISTS `prodesk_subscriptions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prodesk_subscriptions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `therapist_id` int NOT NULL,
  `plan_id` int NOT NULL,
  `status` enum('pending','authenticated','active','halted','cancelled','expired') NOT NULL DEFAULT 'pending',
  `billing_cycle` enum('monthly','annual') NOT NULL,
  `razorpay_subscription_id` varchar(100) DEFAULT NULL COMMENT 'sub_xxx from Razorpay',
  `razorpay_plan_id` varchar(100) DEFAULT NULL COMMENT 'plan_xxx from Razorpay',
  `cancel_at_period_end` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1 = cancel after current period',
  `cancelled_at` timestamp NULL DEFAULT NULL COMMENT 'When cancel was requested',
  `cancellation_reason` varchar(255) DEFAULT NULL,
  `halted_at` timestamp NULL DEFAULT NULL COMMENT 'When Razorpay marked subscription halted',
  `grace_period_end` date DEFAULT NULL COMMENT 'Access allowed until this date when halted',
  `pending_plan_id` int DEFAULT NULL COMMENT 'Plan to switch to at period_end (downgrade)',
  `pending_billing_cycle` enum('monthly','annual') DEFAULT NULL COMMENT 'Billing cycle for pending downgrade',
  `downgrade_requested_at` timestamp NULL DEFAULT NULL,
  `pending_new_subscription_id` int DEFAULT NULL COMMENT 'New sub row created for downgrade/undo-cancel, awaiting mandate',
  `linked_old_subscription_id` int DEFAULT NULL COMMENT 'For new subs: which old sub this replaces',
  `last_upgrade_at` timestamp NULL DEFAULT NULL COMMENT 'Tracks last upgrade to block rapid re-upgrade',
  `cycle_count` int NOT NULL DEFAULT '0' COMMENT 'Number of successful billing cycles',
  `current_period_start` date DEFAULT NULL,
  `current_period_end` date DEFAULT NULL,
  `latest_payment_id` int DEFAULT NULL COMMENT 'FK added after subscription_payments table created',
  `offer_id` int DEFAULT NULL COMMENT 'Offer applied at purchase time',
  `psychologist_count` int DEFAULT '1' COMMENT 'Clinic plan: number of psychologists',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_psub_therapist` (`therapist_id`),
  KEY `fk_psub_plan` (`plan_id`),
  KEY `fk_psub_latest_payment` (`latest_payment_id`),
  KEY `fk_psub_offer` (`offer_id`),
  KEY `idx_sub_rzp_sub_id` (`razorpay_subscription_id`),
  KEY `idx_sub_status_period` (`status`,`current_period_end`),
  CONSTRAINT `fk_psub_latest_payment` FOREIGN KEY (`latest_payment_id`) REFERENCES `prodesk_subscription_payments` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_psub_offer` FOREIGN KEY (`offer_id`) REFERENCES `prodesk_offers` (`id`) ON DELETE SET NULL,
...
--
-- Table structure for table `prodesk_user_offers`
--

DROP TABLE IF EXISTS `prodesk_user_offers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prodesk_user_offers` (
  `id` int NOT NULL AUTO_INCREMENT,
  `offer_id` int NOT NULL,
  `therapist_id` int NOT NULL,
  `subscription_id` int DEFAULT NULL,
  `activated_at` datetime NOT NULL COMMENT 'When therapist entered the code',
  `redeemed_at` datetime DEFAULT NULL COMMENT 'When payment was confirmed',
  `is_redeemed` tinyint(1) DEFAULT '0',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_puo_offer` (`offer_id`),
  KEY `fk_puo_therapist` (`therapist_id`),
...
--
-- Table structure for table `therapist_availability_blocks`
--

DROP TABLE IF EXISTS `therapist_availability_blocks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `therapist_availability_blocks` (
  `id` int NOT NULL AUTO_INCREMENT,
  `therapist_id` int NOT NULL,
...
--
-- Table structure for table `therapist_bank_account_logs`
--

DROP TABLE IF EXISTS `therapist_bank_account_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `therapist_bank_account_logs` (
  `id` int NOT NULL AUTO_INCREMENT,
  `therapist_id` int NOT NULL,
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_tbal_therapist` (`therapist_id`),
  KEY `idx_tbal_created` (`created_at`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `therapist_bank_accounts`
--

DROP TABLE IF EXISTS `therapist_bank_accounts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `therapist_bank_accounts` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `therapist_id` (`therapist_id`),
  KEY `idx_tba_therapist` (`therapist_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `therapist_branding` (
  ...
  `background_preset` varchar(20) DEFAULT 'mist' COMMENT 'gradient preset key: mist, linen, tide, dusk, mono',
  `logo_url` varchar(500) DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `background_type` enum('gradient','preset_wallpaper','custom_wallpaper') DEFAULT 'gradient',
  `wallpaper_id` varchar(50) DEFAULT NULL COMMENT 'preset wallpaper key: misty_peaks, warm_dusk, ocean_calm, forest_fog',
  `wallpaper_url` varchar(500) DEFAULT NULL COMMENT 'S3 URL for custom uploaded wallpaper',
  `invoice_prefix` varchar(20) DEFAULT NULL COMMENT 'e.g. DR-THAKUR — used in invoice numbering',
  PRIMARY KEY (`id`),
...
CREATE TABLE `therapists` (
  ...
  `referral_code` varchar(20) DEFAULT NULL COMMENT 'Auto-generated unique referral code at signup',
...
--
-- Dumping routines for database 'neure_prod'
--
...
-- Dump completed on 2026-07-10 14:17:34
